...
class TTSEngine:
    ...
    def __init__(self, language_code: Optional[str] = None, voice_gender: Optional[str] = None, 
    ...
    def synthesize_text(self, text: str, output_filename: Optional[str] = None, 
                       use_ssml: bool = False, speaking_rate: float = 1.0,
                       pitch: float = 0.0, volume_gain_db: float = 0.0) -> bytes:
        """
    ...
    def batch_synthesize(self, segments: List[TextSegment], 
